...
This document is the required root-level documentation for all additions in `test_module`.
...
### 2026-04-06
- Reset `test_module` contents to a clean baseline structure.
...
- Completed Step 2 reconstruction of traction runtime in `test_module` without protocol changes:
  - Copied components: `traction_hal`, `traction_bridge`, `traction_storage`, `traction_control`, `traction_comm`.
  - Copied traction-style `main/main.c` and `main/CMakeLists.txt` into `test_module`.
  - Kept root `CMakeLists.txt` project identity as `test_module`.
...
- Tools migration for `test_module`:
  - Copied traction UI tools into `test_module/tools`:
    - `tools/pid_tuner`
...
Objective:
- Reconstruct traction firmware inside `test_module` and migrate communication from text command parsing to host framed protocol without breaking current behavior.
...
2. Reconstruct traction runtime in `test_module` (no protocol change yet)
- Copy/adapt traction components into `test_module/components`.
...
- Step 2 output delivered:
  - `test_module` component tree created (`traction_hal`, `traction_bridge`, `traction_storage`, `traction_control`, `traction_comm`)
...
- Step 3 output delivered:
  ...
  - module query frame returns `test_module`
...
- Removed prior placeholder dependency set and populated `test_module/components` from `traction_module/components`.
- Traction runtime pieces now present in `test_module`:
...
- Adopted traction app startup path in `test_module/main/main.c` and matching `main/CMakeLists.txt`.

Build evidence:
- Build target: `esp32c3`
- Result: `Project build complete`
- Binary output: `firmware/esp/modules/test_module/build/test_module.bin`
...
- Module query:
  ...
  - Firmware RX/TX: `MODULE_INFO True test_module`
- Stream command/test:
...
- Build target: `esp32c3`
- Result: `Project build complete`
- Binary size: `0x4c270` bytes (`firmware/esp/modules/test_module/build/test_module.bin`)
- Flash target: `/dev/ttyACM0`, MAC `98:3d:ae:41:9a:40`
- Result: `Hash of data verified` + `Done`
...
- Build target: `esp32c3`
- Result: `Project build complete`
- Binary size: `0x4c430` bytes (`firmware/esp/modules/test_module/build/test_module.bin`)
- Flash target: `/dev/ttyACM0`, MAC `98:3d:ae:41:9a:40`
- Result: `Hash of data verified` + `Done`
...
- Build target: `esp32c3`
- Result: `Project build complete`
- Binary size: `0x4c600` bytes (`firmware/esp/modules/test_module/build/test_module.bin`)
- Flash target: `/dev/ttyACM0`, MAC `98:3d:ae:41:9a:40`
- Result: `Hash of data verified` + `Done`
...
- Build target: `esp32c3`
- Result: `Project build complete`
- Binary size: `0x4c890` bytes (`firmware/esp/modules/test_module/build/test_module.bin`)
- Flash target: `/dev/ttyACM0`, MAC `98:3d:ae:41:9a:40`
- Result: `Hash of data verified` + `Done`
...
- Build target: `esp32c3`
- Result: `Project build complete`
- Binary size: `0x4cba0` bytes (`firmware/esp/modules/test_module/build/test_module.bin`)
- Flash target: `/dev/ttyACM0`, MAC `98:3d:ae:41:9a:40`
- Result: `Hash of data verified` + `Done`
...
- Build target: `esp32c3`
- Result: `Project build complete`
- Binary size: `0x4d040` bytes (`firmware/esp/modules/test_module/build/test_module.bin`)
- Flash target: `/dev/ttyACM0`, MAC `98:3d:ae:41:9a:40`
- Result: `Hash of data verified` + `Done`
...
- Build target: `esp32c3`
- Result: `Project build complete`
- Binary size: `0x4bf10` bytes (`firmware/esp/modules/test_module/build/test_module.bin`)
- Flash target: `/dev/ttyACM0`, MAC `98:3d:ae:41:9a:40`
- Result: `Hash of data verified` + `Done`
