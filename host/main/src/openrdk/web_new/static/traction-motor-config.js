(function () {
  ...
  let _controllerConnected = false;
  ...
  function syncControllerButtons() {
    if (!curveRun) {
      readCurveBtn.disabled = !_controllerConnected;
      writeCurveBtn.disabled = !_controllerConnected;
      generateCurveBtn.disabled = !_controllerConnected;
      saveConfigBtn.disabled = !_controllerConnected;
    }
  }
  ...
  function setCurveButtonsBusy(active) {
    ...
    if (active) {
      readCurveBtn.disabled = true;
      writeCurveBtn.disabled = true;
      generateCurveBtn.disabled = true;
